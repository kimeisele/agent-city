...
class HealthCheckBuilder:
    ...
    def build_schema(self) -> str:
        return (
            ...
            "RULE: If an active mission already addresses a problem (check "
            "the Active missions list in the payload), do NOT create another "
            "mission for it. Only create_mission for NEW unaddressed problems.\n\n"
